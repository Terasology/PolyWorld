...
/**
 * Converts graph-based elevation information of the {@link ElevationModelFacet} into a continuous area.
 */
...
public class ElevationProvider implements FacetProvider {
    ...
    public void process(GeneratingRegion region) {
        ...
        if (traceLog) {
            logger.trace("Created elevation facet for {} in {}ms.", facet.getWorldRegion(),
