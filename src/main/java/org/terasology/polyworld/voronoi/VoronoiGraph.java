...
public abstract class VoronoiGraph {
    ...
    private static boolean liesOnAxes(Rectangle r, Point p) {
        return closeEnough(p.x, r.x, 1) || closeEnough(p.y, r.y, 1) || closeEnough(p.x, r.right, 1) || closeEnough(p.y, r.bottom, 1);
    }
